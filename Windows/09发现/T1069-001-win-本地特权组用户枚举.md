...
- Atomic Red Team - T1069.001 测试用例: <https://github.com/redcanaryco/atomic-red-team/blob/master/atomics/T1069.001/T1069.001.md>
- Sysmon 配置指南: <https://github.com/SwiftOnSecurity/sysmon-config>
- PowerShell 日志配置指南: <https://docs.microsoft.com/en-us/powershell/windows-server/security/threat-protection/auditing-and-logging>
...
- Active Directory 安全最佳实践: <https://docs.microsoft.com/en-us/windows-server/identity/ad-ds/plan/security-best-practices>