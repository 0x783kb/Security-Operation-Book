...
- **MITRE ATT&CK - T1482**： <https://attack.mitre.org/technical/T1614/002/>
- **Atomic Red Team - T1614 测试用例**： <https://github.com/redcanaryco/atomic-red-team/blob/master/atomics/T1614/T1614.md>
...
- **Elastic SIEM 检测规则**： <https://www.elastic.co/guide/security/current/detection-rules.html>
- **Windows 时间配置**： <https://docs.microsoft.com/en-us/windows/server/admin/windows-commands/time>
- **网络防护**： <https://docs.microsoft.com/en-us/windows/security/threat-protection/windows-firewall/best-pratices-firewall>