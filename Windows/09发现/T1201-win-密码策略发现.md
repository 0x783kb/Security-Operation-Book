...
- Atomic Red Team - T1201 测试用例: <https://github.com/redcanaryco/atomic-red-team/blob/master/atomics/T1201/T1201.md>
...
- Windows 密码策略配置: <https://docs.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/password-policy>
- Active Directory 安全配置: <https://docs.microsoft.com/en-us/windows-server/identity/ad-ds/plan/security-best-practices>