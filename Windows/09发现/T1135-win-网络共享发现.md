...
- Atomic Red Team - T1135 测试用例: <https://github.com/redcanaryco/atomic-red-team/blob/master/atomics/T1135/T1135.md>
...
- Windows SMB 安全: <https://docs.microsoft.com/en-us/windows-server/storage/file-server/troubleshoot/smb-security>
- AWS EFS 监控: <https://docs.aws.amazon.com/efs/latest/ug/monitoring-cloudwatch.html>
- Azure 文件共享安全: <https://docs.microsoft.com/en-us/azure/storage/files/storage-files-security>
```
